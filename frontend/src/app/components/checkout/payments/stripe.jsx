...
export default function Head_stripe({ onError, onSuccess }) {
    ...
    address: {
        ...
        fetch(
            `/api/verify/checkout/stripe/complete?session_id=${param.get("session_id")}`,
            {
                method: 'POST',
                credentials: "include",
                headers: {
        ...
        .then(async (r) => {
            if (!r.ok) {
                ...
                throw new Error(
                    data.error?.message || data.error || "Payment failed"
                );
            }
        ...
        .then(async (data) => {
            try {
                ...
                if (
                    ...
                    const { paymentIntent } =
                        await stripe.confirmCardPayment(data.id, {
                            payment_method: {
        ...
        />
                ...
                <div className="flex items-center gap-2">
                    <div>
                        ...
                        >
                            <path
                                d="M3.11111 0C1.393 0 0 1.393 0 3.11112V10.8889C0 12.607 1.393 14 3.11111 14H10.8889C12.607 14 14 12.607 14 10.8889V3.11112C14 1.393 12.607 0 10.8889 0ZM7 3.11112C7.42933 3.11112 7.77778 3.45957 7.77778 3.8889C7.77778 4.31824 7.42933 4.66668 7 4.66668C6.57067 4.66668 6.22222 4.31824 6.22222 3.8889C6.22222 3.45957 6.57067 3.11112 7 3.11112ZM7 5.44446C7.42933 5.44446 7.77778 5.79291 7.77778 6.22224V10.1111C7.77778 10.5405 7.42933 10.8889 7 10.8889C6.57067 10.8889 6.22222 10.5405 6.22222 10.1111V6.22224C6.22222 5.44446 7 5.44446 7 5.44446Z"
                                fill="#53535F"
                            />
                        </svg>
                    </div>
